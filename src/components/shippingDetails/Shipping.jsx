...
const Shipping = () => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row lg:mx-8 px-8 gap-5">
        <div className="container   lg:w-[70%] flex flex-col md:flex-row gap-3 border">
          <div className="flex flex-col py-6 border-r">
            <button
              ...
              className={`p-2 py-3 text-[14px] border ${
                !showDiscountCode
                  ? "bg-black text-white"
                  : "text-black bg-white"
              }`}
          ...
          {showDiscountCode ? (
            <div className="flex flex-col p-6 mb-5 md:w-[70%]">
              <input
                ...
                className="mb-2 p-2 border border-gray-300 rounded-3xl px-5 text-[14px] focus:outline-none"
              />
              <button className="bg-black text-white px-4 py-2 rounded-3xl text-[14px] hover:bg-[#D19C88] md:w-1/3">
                Apply Discount
              </button>
            </div>
          ) : (
            <div className="mb-4 p-6 md:w-[70%]">
              ...
              <div className="flex flex-row items-center justify-between mb-5">
                <label
                  htmlFor="country"
                  className="block text-sm font-semibold mb-1 text-[14px]"
                >
                  Country
                </label>
                <select
                  id="country"
                  className=" p-3 border border-gray-300 rounded-3xl text-[14px] px-4 w-3/4 focus:outline-none"
              ...
              <div className="flex flex-row items-center justify-between mb-5">
                <label
                  htmlFor="province"
                  className="block text-sm font-semibold mb-1 focus:outline-none"
                >
                  State/Province
                </label>
                <select
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center mb-2">
                  ...
                  />
                  <label htmlFor="free" className="text-[14px]">
                    Free - $0.00
                  </label>
                </div>
                <h3 className="text-[14px] font-semibold mb-2">FLAT RATE</h3>
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="flat" className="text-[14px]">
                    Fixed - $20.00
                  </label>
                </div>
              </div>
        ...
        <div className="lg:w-[30%]   ">
          <div className="px-3 border  flex justify-between py-5">
            <h3 className="text-[14px]  mb-2">Subtotal</h3>
            <p className="text-[14px]">${subTotal.toFixed(2)}</p>
          </div>
          <div className="px-3 border  flex justify-between py-5">
            <h3 className="text-[20px]  mb-2">Order Total</h3>
